...
VkResult debug_utils_messenger_create(VkInstance instance,
...
void debug_utils_messenger_destroy(VkInstance instance, VkDebugUtilsMessengerEXT debug_messenger, const VkAllocationCallbacks *allocator) {
